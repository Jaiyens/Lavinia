...
describe("GENERATED_REPORT_KINDS", () => {
  it("carries the export tables plus the PDF report kind (Story 9.3) and the bill-dispute packet kind", () => {
    expect([...GENERATED_REPORT_KINDS]).toEqual(["meters", "billDue", "report", "bill_dispute"]);
  });
});
