...
// The Almond Logic HOME — the module's landing (/almondlogic). The portal shell (layout.tsx) renders
// the grower header, the screen sub-nav, and the hullers/handlers sidebar; this page renders the main
// content: the farm cost-per-pound headline (the differentiator number, links to the full Cost view),
// then the two-column "Grower Portal News" + "Recent Activity" home. Gagan's production worksheet is
// the "Crop position" tab (/almondlogic/worksheet). Server Component, farmId-scoped; every figure comes
// from the pure cost engine via resolveCostPerPound and is only formatted here.
