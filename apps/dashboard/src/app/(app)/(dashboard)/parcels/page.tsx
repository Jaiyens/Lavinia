...
// farmer's own blocks are preloaded and drawn on top; every other parcel streams in live per
// viewport from the county engine. Server-loads the farm fixture and hands it to the client map.
